...
for (const directory of ['styles', 'theme', 'vendor']) await mkdir(`ui/dist/${directory}`, { recursive: true });
for (const file of ['index.html', 'newtab.html', 'terminal.html', 'styles/terminal.css', 'styles/shell.css', 'styles/newtab.css', 'theme/tokens.css']) {
